...
namespace DBAccessLib.StoreProcedure
{
    /// <summary>
    /// 存储过程
    /// </summary>
    public class StoreProcedureOfSql
    {
        // 连接字符串。
        ...
        public StoreProcedureOfSql(string connectionString)
        {
        ...
        public StoreProcedureOfSql(string connectionString, string storeProcedureName)
        {
            this.connectionString = connectionString;
